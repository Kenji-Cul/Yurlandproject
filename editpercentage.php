...
<body>
            ...
            <section class="login-form-container">
                <form action="" class="login-form" id="address-form">
                    <div class="input-div email">
                        <label for="percent">Customer Percentage</label>
                        <input type="number" id="percent" placeholder="Input customer percentage" name="customerpercent"
                            value="<?php if(isset($newuser['earning_percentage'])){
                    echo $newuser['earning_percentage'];
                }?>" />
                    </div>
    ...
    $(document).ready(function() {
        ...
        $("#address-form .btn").click(function() {
            $.ajax({
                type: "POST",
                url: "inserters/insertpercentage.php",
