...
<body class="profile-body">
    ...
    <div class="flex-container">
        ...
        <div class="profile-container">
            <div class="page-title2">
                ...
                <?php }?>
                <p>Rejected Offline Transactions</p>
            </div>
    ...
    ?>
            ...
            <div class="navigation-div" style="margin-top: 2em;">
                <div class="navig">
                    ...
                    <div class="payment">Approval Date</div>
                    <div class="payment hide">Status</div>
                </div>
            </div>
    ...
    $user = new User;
           ...
           if(!empty($total)){
            ...
            foreach ($total as $key => $value) {
             ...
             ?></span></p>
                    ...
                    <div class="details flexdetail" style="text-transform: capitalize;">
                        <p class="pname email-span"> <?php echo $value['update_date'];?></p>
                    </div>

                    <div class="details hide flexdetail" style="text-transform: capitalize;">
                        <p class="pname email-span"> <?php if($value['offline_status'] == ""){
                            echo "Approved";
                        } else {
                            echo $value['offline_status'];
                        }?></p>
           ...
           ?>
                ...
                <div class="success">
                    ...
                    <p>There are no rejected offline payments yet!</p>
                </div>
                <?php }?>
    ...
    function htmlTableToExcel(type) {
        ...
        XLSX.writeFile(file, 'rejectedofflinepayments.' + type);
    }
