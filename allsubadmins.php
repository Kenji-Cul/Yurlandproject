...
<body class="profile-body">
                    ...
                    <div class="search-input">
                        <form action="" class="search-form">
                            <input type="text" class="search" type="search" name="searchproduct"
                                placeholder="Search For Subadmin">
                        </form>
                    </div>
                </div>
            </div>
    ...
    $customer = $user ->selectAllSubadmins();
    if(!empty($customer)){
        foreach($customer as $key => $value){
    ?>
                    <tr>
                        <td><?php echo $value['subadmin_id'];?></td>
                        <td><?php echo $value['subadmin_name'];?></td>
                        <td><?php echo $value['subadmin_num'];?></td>
            ...
            <div class="navigation-div" style="margin-top: 2em;">
                <div class="navig">
                    ...
                    <div class="payment hide">Phone</div>
                    <div class="payment hide">Agents reg</div>
                    <div class="payment hide">Customers Reg</div>
                    <div class="payment hide">Units Sold</div>
                    <div class="payment">Payment Processed</div>
    ...
    $customer = $user ->selectAllSubadmins();
    $customer2 = $user ->selectAllUsers();
    if(!empty($customer)){
    foreach($customer as $key => $value){
        $subadminid = $value['unique_id'];
    ?>
                ...
                <div class="transaction-details2">
                    <div class="details" style="text-transform: capitalize;">
                        <p class="pname email-span">
                            <span><?php echo $value['subadmin_name'];?></span>
                        </p>
                    </div>

                    <div class="details hide flexdetail" style="text-transform: lowercase;">
                        <p class="pname email-span">
                            <span><?php echo $value['subadmin_email'];?></span>
                        </p>
                    </div>

                    <div class="details hide flexdetail" style="text-transform: lowercase;">
                        <p class="pname email-span">
                            <span><?php echo $value['subadmin_num'];?></span>
                        </p>
                    </div>
                    ...
                    <div class="details hide flexdetail" style="text-transform: lowercase;">
                        <p class="pname email-span">
                            <span><?php 
                            $agentsreg = $user->selectAgentsReg($value['unique_id']);
                            foreach($agentsreg as $key => $value3){
                                if(is_null($value3)){
                                  echo "0";
                                } else {
                                 echo $value3;
                    ...
                    <div class="details hide flexdetail" style="text-transform: lowercase;">
                        <p class="pname email-span">
                            <span><?php 
                            $customersreg = $user->selectUsersReg($value['unique_id']);
                            foreach($customersreg as $key => $value3){
                                if(is_null($value3)){
                                  echo "0";
                                } else {
                                 echo $value3;
                    ...
                    <div class="details hide flexdetail" style="text-transform: capitalize;">
                     ...
                     $total = $user->selectSumUnits2($value['unique_id']);
            ...
            ?></p>
                    ...
                    <div class="details" style="text-transform: capitalize;">
                     ...
                     $total = $user->selectTotal2($value['unique_id']);
                foreach($total as $key => $value3){
                  if(is_null($value3)){
                    echo "0";
                  } else {
            ...
            ?></p>
                    ...
                    <div class="details" style="text-transform: capitalize;">
                        <div class="detail" style="">
                            <a href="subinfo.php?unique=<?php echo $subadminid;?>&real=91838JDFOJOEI939">
                ...
                <div class="success">
                    ...
                    <p>There are no subadmins yet!</p>
                </div>
                <?php }?>
            </div>
    ...
    searchIcon.onclick = () => {
        ...
        searchinput2.onkeyup = () => {
            ...
            xhr.open("POST",
                `searchsubadmin.php?user=supadmin`);
    ...
    function htmlTableToExcel(type) {
        ...
        XLSX.writeFile(file, 'subadmindata.' + type);
    }
