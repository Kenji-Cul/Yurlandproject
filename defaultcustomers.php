...
<body class="profile-body">
    ...
    ?>
                ...
                <div class="account-detail2">
                    <div class="radius">
                        <?php if(!empty($lastpaiduser['photo'])){?>
                        <img src="profileimage/<?php echo $lastpaiduser['photo'];?>" alt="profile image" />
                        <?php }?>
                        <?php if(empty($lastpaiduser['photo'])){?>
                        <div class="empty-img">
                            <i class="ri-user-fill"></i>
                    ...
                    <div class="flex">
                        <p style="text-transform: capitalize;">
                            <span><?php echo $lastpaiduser['first_name'];?></span>&nbsp;<span><?php echo $lastpaiduser['last_name'];?></span>
                        </p>
                        <p class="email-span" style="text-transform: lowercase;"><?php echo $lastpaiduser['email'];?>
                        </p>
                        <p style="text-transform: capitalize;">
                            <span>Last Pay Date: <?php echo $lastsevendays; ?></span></span>
                        </p>
                    </div>
