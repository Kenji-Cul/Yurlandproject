    ...
    <div class="flex-container">
        ...
        <div class="profile-container">
            <div class="page-title2">
                ...
                <p>Create New Executive</p>
            </div>

            <!-- Landing Page Text -->
            <!-- <section class="landing_text_container" style="border: 1px solid black; padding-top: 0;">
                ...
                <form action="" class="login-form" id="login-form">
                    ...
                    <div class="input-div name">
                        ...
                        <input type="number" id="phonenum" name="phonenum"
                            placeholder="Input executive's phone number" />
                    </div>

                    <div class="input-div name">
                        <label for="bankname">Bank Name</label>
                        <input type="text" id="bankname" name="bankname" placeholder="Input executive's bank name" />
                    </div>
        ...
        <div class="modalcon">
            <div class="modaldiv">
                <div>
                    ...
                    <a href="supadmininfo.php"><button class="landing_page_button2">Back to Dashboard</button></a>
                </div>
            </div>
        </div>
    </div>
