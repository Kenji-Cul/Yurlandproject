...
<body class="profile-body">
    ...
    purpose2.forEach((element) => {
        element.onclick = () => {
            ...
            xhr.open("POST",
                `searchexecutivebymonth.php?data=${valuediv2.innerHTML}&user=monthearn`);
    ...
    searchIcon.onclick = () => {
        ...
        searchinput2.onkeyup = () => {
            let xhr = new XMLHttpRequest();
            xhr.open("POST",
                `searchexecutive.php?user=agenttotal`);
    ...
    downloadbtn.onclick = () => {
        let xhr = new XMLHttpRequest();
        xhr.open("POST",
            `downloadexecearnings.php?user=download&dataone=${valuediv2.innerHTML}&datatwo=${searchforminput.value}`
        );
