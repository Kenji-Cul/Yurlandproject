...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    if(empty($userEmail)){
       header("Location: superadminpassword.php?user=Please input your email");
    } 
...
if(isset($_POST['fgtpass'])){
    ...
    $url = "http://localhost/Yurland/superadminrandom.php?selector=". $selector. "&rand=". $random;;
    ...
    require "db.php";
        ...
        $sql2 = "UPDATE super_admin SET token='{$selector}' WHERE super_adminemail = '{$userEmail}'";
        $conn = mysqli_stmt_init($dbcon);
...
header("Location: superadminpassword.php?reset=success");
