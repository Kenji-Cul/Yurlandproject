...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    if(empty($userEmail)){
       header("Location: executivepassword.php?user=Please input your email");
    } 
...
if(isset($_POST['fgtpass'])){
    ...
    $url = "http://localhost/Yurland/executiverandom.php?selector=". $selector. "&rand=". $random;;
    ...
    require "db.php";
        ...
        $sql2 = "UPDATE executive SET token='{$selector}' WHERE executive_email = '{$userEmail}'";
        $conn = mysqli_stmt_init($dbcon);
...
header("Location: executivepassword.php?reset=success");
