...
<body class="body">
    ...
    <?php 
             $user = new User;
             $newuser = $user->selectExecutive($_GET['unique']);
            ?>
    ...
    <div class="flex-container">
        ...
        <div class="profile-container">
            ...
            <div class="page-title2">
                <?php if(isset($_SESSION['uniquesupadmin_id'])){?>
                <a href="execinfo.php?unique=<?php echo $newuser['unique_id'];?>&real=91838JDFOJOEI939">
                    <img src="images/arrowleft.svg" alt="" />
                </a>
                <?php }?>
                <div style="display: flex !important; flex-direction: column !important" class="estatetext">
                    <p class="email-span">Edit
                        <span><?php if(isset($newuser['full_name'])){echo $newuser['full_name'];}?></span>
                    </p>
                </div>
            </div>
            ...
            <section class="login-form-container">
                <form action="" class="login-form" id="signup-form">
                    <div class="input-div name">
                        ...
                        <input type="text" id="execname" placeholder="Edit executive name" name="execname"
                            value="<?php if(isset($newuser['full_name'])){echo $newuser['full_name'];}?>" />
                    </div>
                    ...
                    <div class="input-div email">
                        ...
                        <input type="text" id="email" placeholder="Edit email address" name="email"
                            value="<?php if(isset($newuser['executive_email'])){echo $newuser['executive_email'];}?>" />
                    </div>

                    <div class="input-div email">
                        <label for="phonenum">Phone Number</label>
                        <input type="number" id="phonenum" placeholder="Edit phone number" name="phonenum"
                            value="<?php if(isset($newuser['executive_num'])){echo $newuser['executive_num'];}?>" />
                    </div>

                    <div class="input-div name">
                        <label for="bankname">Bank Name</label>
                        <input type="text" id="bankname" name="bankname" placeholder="Edit executive's bank name"
                    ...
                    <div class="input-div name">
                        ...
                        <input type="number" id="accountnum" name="accountnum"
                            placeholder="Input executive's account number"
                            value="<?php if(isset($newuser['account_number'])){echo $newuser['account_number'];}?>" />
                    </div>

                    <div class="input-div email">
                        <label for="earning">Earning Percentage</label>
                        <input type="number" id="earning" placeholder="Edit earning percentage" name="earning"
                    ...
                    <div class="input-div email">
                        ...
                        <input type="text" name="text" placeholder="Upload executive profile image" disabled />
                        <input type="file" id="passport" placeholder="Upload executive profile image" name="image"
                    ...
                    <button class="btn" type="submit">Edit Executive</button>
        ...
        <div class="modalcon">
            <div class="modaldiv">
                <div>
                    ...
                    <a href="execinfo.php?unique=<?php echo $_GET['unique'];?>&real=91838JDFOJOEI939"><button
    ...
    function uploadFile(name) {
        ...
        xhr.open("POST", "inserters/editexecdetails.php", true);
