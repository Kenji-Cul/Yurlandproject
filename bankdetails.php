...
<body>
            ...
            <section class="login-form-container">
                <form action="" class="login-form" id="address-form">
                    <div class="input-div email">
                        ...
                        <input type="text" id="bankname" placeholder="Input bank name" name="bankname" value="<?php if(isset($newuser['bank_name'])){
                    ...
                    <div class="input-div email">
                        ...
                        <input type="text" id="accountnum" placeholder="Input account number" name="accountnum" value="<?php if(isset($newuser['account_number'])){
    ...
    $(document).ready(function() {
        ...
        $("#address-form .btn").click(function() {
            $.ajax({
                type: "POST",
                url: "inserters/insertbankdetails.php",
