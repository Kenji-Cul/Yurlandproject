...
<body class="profile-body">
    ...
    <div class="flex-container">
        ...
        <div class="profile-container">
            ...
            <div class="page-title2">
                <a href="allsubadmins.php">
                    <img src="images/arrowleft.svg" alt="" />
                </a>
                <?php 
    $user = new User;
    $agent = $user->selectSubadmin($_GET['unique']);
    ...
    ?>
            ...
            <div class="profile-image" style="margin-left: 3em;">
                <?php if(!empty($agent['subadmin_image'])){?>
                <img src="profileimage/<?php echo $agent['subadmin_image'];?>" alt="profile image" />
                <?php }?>
                <?php if(empty($agent['subadmin_image'])){?>
            ...
            <div class="details-container">
                ...
                <div class="account-detail2">
                    <div>
                        <p><?php if(isset($agent['subadmin_name'])){  ?>
                            <?php echo $agent['subadmin_name']; ?><span>&nbsp;
                                <?php }?>
                        </p>

                        <span> <?php if(empty($agent['subadmin_image'])){
?>
                ...
                <div class="account-detail2">
                    <div>
                        ...
                        <span><?php if(isset($agent['subadmin_num'])){  ?>
                            <?php echo $agent['subadmin_num']; ?><span>&nbsp;
                                <?php }?></span>
                    </div>
                </div>
                ...
                <div class="account-detail2">
                    <div>
                        ...
                        <span><?php if(isset($agent['subadmin_email'])){  ?>
                            <?php echo $agent['subadmin_email']; ?><span>&nbsp;
                                <?php }?></span>
                        </span>
                    </div>
                </div>
            ...
            <div class="flexbtn-container">
                <?php if(isset($_SESSION['uniquesupadmin_id'])){?>
                <a href="editsubadmin.php?unique=<?php echo $agent['unique_id'];?>">
                    <button class="btn land-btn">Edit Subadmin</button>
                </a>
                <?php }?>


                <?php if(isset($_SESSION['uniquesupadmin_id'])){?>
                <?php if($agent['subadmin_status'] == "Disabled"){?>
                <form id="agentform2">
                    <input type="hidden" name="agentid2" id="agentid2" value="<?php echo $agent['unique_id'];?>">
                    <button class="btn land-btn">Enable Subadmin</button>
                </form>
                <?php } else {  ?>
                <form id="agentform">
                    <input type="hidden" name="agentid" id="agentid" value="<?php echo $agent['unique_id'];?>">
                    <button class="btn land-btn">Disable Subadmin</button>
                </form>
                <?php }}?>
        ...
        <div class="modalcon">
            <div class="modaldiv">
                ...
                <div>
                    ...
                    <?php if($agent['subadmin_status'] == "Disabled"){?>
                    <p>Subadmin Enabled</p>
                    <p>Successfully</p>
                    <?php } else {?>
                    <p>Subadmin Disabled</p>
                    <p>Successfully</p>
    ...
    function enable() {
        ...
        xhr.open("POST", `enablesubadmin.php`, true);
        xhr.onload = () => {
    ...
    function disable() {
        let xhr = new XMLHttpRequest();
        xhr.open("POST", `disablesubadmin.php`, true);
        xhr.onload = () => {
            if (xhr.readyState === XMLHttpRequest.DONE) {
                if (xhr.status === 200) {
                    let data = xhr.response;
