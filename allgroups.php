...
<body class="profile-body">
    ...
    ?>
                <a href="groupmembers.php?unique=<?php echo $value['uniquegroup_id'];?>">
                    <div class="account-detail2">
                        <div class="radius">
                            <?php if(!empty($value['group_img'])){?>
                            <img src="profileimage/<?php echo $value['group_img'];?>" alt="profile image" />
                            <?php }?>
                            <?php if(empty($value['group_img'])){?>
                            <div class="empty-img">
                                <i class="ri-user-fill"></i>
                        ...
                        <div class="flex">
                            <p style="text-transform: capitalize;">
                                <span>Group Head:&nbsp;&nbsp;&nbsp;<?php echo $value['group_head'];?></span>
                            </p>
                            <p style="text-transform: capitalize;">
                                <span>Group Name:&nbsp;&nbsp;&nbsp;<?php echo $value['group_name'];?></span>
                            </p>
                            <p style="text-transform: capitalize;">
                                <span>Group Location:&nbsp;&nbsp;&nbsp;<?php echo $value['group_location'];?></span>
                            </p>
