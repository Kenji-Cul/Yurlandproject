...
<body class="profile-body">
            ...
            <div class="user">
                ...
                <div class="profile-image">
                    ...
                    <a href="supadmininfo.php" style="color: #808080;">
                        <div class="empty-img" tyle="border-radius: 50%;">
                            <i class="ri-user-fill"></i>
                        </div>
                    </a>
                    <?php }?>
    ...
    ?>
                    <tr>
                        ...
                        <td><?php echo $value['group_head'];?></td>
                        <td><?php echo $value['group_location'];?></td>
                    </tr>
                    <?php }}?>
                </tbody>
            </table>
            ...
            <div class="navigation-div" style="margin-top: 2em;">
                <div class="navig">
                    <div class="payment">Group Name</div>
                    <div class="payment hide">Location</div>
                    <div class="payment hide">Group Head</div>
                    <div class="payment">User Count</div>
...
?>
                ...
                <div class="transaction-details2">
                    ...
                    <div class="details hide flexdetail" style="text-transform: capitalize;">
                        <p class="pname email-span">
                            <span><?php echo $value['group_location'];?></span>
                        </p>
                    </div>

                    <div class="details hide flexdetail" style="text-transform: capitalize;">
                        <p class="pname email-span">
                            <span><?php echo $value['group_head'];?></span>
                        </p>
                    </div>
                    ...
                    <div class="details" style="text-transform: capitalize;">
                        <p class="sname">
                            <span><?php 
                             $groupcount = $user->selectGroupCount($groupid);
                             echo $groupcount;
                            ?></span>
                        </p>
                    </div>
                    ...
                    <div class="details" style="text-transform: capitalize;">
                        <div class="detail" style="">
                            <a href="groupinfo.php?unique=<?php echo $groupid;?>&real=91838JDFOJOEI939">
    ...
    function htmlTableToExcel(type) {
        ...
        XLSX.writeFile(file, 'groupdata.' + type);
    }
