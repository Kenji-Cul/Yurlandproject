...
<body class="profile-body">
    ...
    <div class="flex-container">
        ...
        <div class="profile-container">
            ...
            $earning = $user->selectAgentHistory($value3['uniqueagent_id']);
            if(!empty($earning)){
                foreach($earning as $key => $value){
    ?>
                <?php if($value3['agent_date'] <= $value['payment_date']){
                if($value3['earning_percentage'] != ""){  ?>
                <div class="account-detail2"
                    style="height: 3em; display: flex; justify-content: space-between; align-items:center;">
                    <div class="flex">
                        <p style="text-transform: uppercase;">
                            <span style="color: #000000!important; font-size: 16px;"><?php echo $value3['agent_name']?>
                    ...
                    ?>
                        ...
                        <div class="payee">
                            <p class="payee-tag" style="color: #808080;">
                                ...
                                if($value['payee'] == $value3['agent_name']){
