    ...
    <section class="login-form-container">
        <form action="" class="login-form" id="login-form">
            <div class="input-div name">
                ...
                <input type="email" id="email" name="subadminemail" placeholder="Input your email" value="<?php 
                 if(isset($_COOKIE['subadmin_login'])){
                    echo $_COOKIE['subadmin_login'];
                 }
                ?>" />
            </div>
            ...
            <div class="input-div password">
                ...
                <input type="password" placeholder="Input your password" id="password" name="password" value="<?php 
                 if(isset($_COOKIE['subadmin_password'])){
                    echo $_COOKIE['subadmin_password'];
                 }
                ?>" />
            ...
            <div class="input-div remember-div">
                <label class="radio" for="check">
                    <input type="checkbox" id="check" name="remember" <?php if(isset($_COOKIE['subadmin_login'])){?>
                        checked <?php }?> />
                    <span class="check"></span>
                    <p>Remember me</p>
                </label>
                <div class="remember">
                    <a href="subadminpassword.php">Forgot Password?</a>
                </div>
            </div>
