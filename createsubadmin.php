            ...
            <section class="login-form-container">
                <form action="" class="login-form" id="subadmin-form">
                    <div class="input-div name">
                        ...
                        <input type="text" id="name" name="subadminname" placeholder="Input full name" />
                    </div>

                    <div class="input-div name">
                        <label for="email">Email</label>
                        <input type="text" id="email" name="subadminemail" placeholder="Input full email" />
                    </div>

                    <div class="input-div name">
                        <label for="num">Phone Number</label>
                        <input type="text" id="num" name="subadmin_number" placeholder="Input phone number" />
                    </div>
