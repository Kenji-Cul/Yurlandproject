...
<body class="body">
    ...
    <?php 
             $user = new User;
             $newuser = $user->selectSubadmin($_GET['unique']);
            ?>
    ...
    <div class="flex-container">
        ...
        <div class="profile-container">
            ...
            <div class="page-title2">
                <?php if(isset($_SESSION['uniquesupadmin_id'])){?>
                <a href="subinfo.php?unique=<?php echo $newuser['unique_id'];?>&real=91838JDFOJOEI939">
                    <img src="images/arrowleft.svg" alt="" />
                </a>
                <?php }?>
                <div style="display: flex !important; flex-direction: column !important" class="estatetext">
                    <p class="email-span">Edit
                        <span><?php if(isset($newuser['subadmin_name'])){echo $newuser['subadmin_name'];}?></span>
                    </p>
                </div>
            </div>
            ...
            <section class="login-form-container">
                <form action="" class="login-form" id="signup-form">
                    <div class="input-div name">
                        ...
                        <input type="text" id="subadminname" placeholder="Edit subadmin name" name="subadminname"
                            value="<?php if(isset($newuser['subadmin_name'])){echo $newuser['subadmin_name'];}?>" />
                    </div>

                    <div class="input-div name">
                        <label for="subadminnum">Subadmin Number</label>
                        <input type="number" id="subadminnum" placeholder="Edit subadmin number" name="subadminnum"
                            value="<?php if(isset($newuser['subadmin_num'])){echo $newuser['subadmin_num'];}?>" />
                    </div>

                    <div class="input-div email">
                        <label for="email">Email</label>
                        <input type="text" id="email" placeholder="Edit email address" name="email"
                            value="<?php if(isset($newuser['subadmin_email'])){echo $newuser['subadmin_email'];}?>" />
                    </div>


                    <div class="input-div email">
                        <label>Profile Image</label>
                        <input type="text" name="text" placeholder="Upload subadmin profile image" disabled />
                        <input type="file" id="passport" placeholder="Upload subadmin profile image" name="image"
                    ...
                    <button class="btn" type="submit">Edit Subadmin</button>
        ...
        <div class="modalcon">
            <div class="modaldiv">
                <div>
                    ...
                    <p>Subadmin Details!</p>
                    <p>Updated Successfully</p>
                    <a href="subinfo.php?unique=<?php echo $_GET['unique'];?>&real=91838JDFOJOEI939"><button
    ...
    function uploadFile(name) {
        ...
        xhr.open("POST", "inserters/editsubdetails.php", true);
