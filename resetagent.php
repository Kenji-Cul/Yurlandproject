...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    if(empty($userEmail)){
       header("Location: agentpassword.php?user=Please input your email");
    } 
...
if(isset($_POST['fgtpass'])){
    ...
    $url = "http://localhost/Yurland/agentrandom.php?selector=". $selector. "&rand=". $random;;
    ...
    require "db.php";
        ...
        $sql2 = "UPDATE agent_table SET token='{$selector}' WHERE agent_email = '{$userEmail}'";
        $conn = mysqli_stmt_init($dbcon);
...
header("Location: agentpassword.php?reset=success");
