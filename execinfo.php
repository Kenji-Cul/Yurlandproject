    ...
    ?>
            ...
            <div class="details-container">
                ...
                <div class="account-detail2">
                    <div>
                        <p><?php if(isset($agent['full_name'])){  ?>
                            <?php echo $agent['full_name']; ?><span>&nbsp;
                                <?php }?>
                        </p>

                        <span> <?php if(empty($agent['executive_img'])){
?>
                ...
                <div class="account-detail2">
                    <div>
                        ...
                        <span><?php if(isset($agent['executive_email'])){  ?>
                            <?php echo $agent['executive_email']; ?><span>&nbsp;
                                <?php }?></span>
                        </span>
                    </div>
                </div>
                ...
                <div class="account-detail2">
                    <div>
                        ...
                        <span><?php if(isset($agent['executive_num'])){  ?>
                            <?php echo $agent['executive_num']; ?><span>&nbsp;
                                <?php }?></span>
                        </span>
                    </div>
                </div>
                ...
                <div class="account-detail2">
                    <div>
                        ...
                        <span><?php if(isset($agent['earning'])){ ?>
                            <?php echo $agent['earning']; ?><span>%
                                <?php }?></span>
                            </p>
                        </span>
                    </div>
            ...
            <div class="flexbtn-container">
                <?php if(isset($_SESSION['uniquesupadmin_id'])){?>
                <a href="editexecutive.php?unique=<?php echo $agent['unique_id'];?>">
                    <button class="btn land-btn">Edit Executive</button>
                </a>

                <a href="executivehistory.php?unique=<?php echo $agent['unique_id'];?>">
                    <button class="btn land-btn">Earning History</button>
                </a>
                <?php }?>
            </div>
