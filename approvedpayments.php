...
<body class="profile-body">
    ...
    <div class="flex-container">
        ...
        <div class="profile-container">
            <div class="page-title2">
                ...
                <?php }?>
                <p>Approved Offline Transactions</p>
            </div>
    ...
    $user = new User;
           ...
           ?>
                ...
                <div class="success">
                    ...
                    <p>There are no approved offline payments yet!</p>
                </div>
                <?php }?>
    ...
    function htmlTableToExcel(type) {
        ...
        XLSX.writeFile(file, 'approvedofflinepayments.' + type);
    }
