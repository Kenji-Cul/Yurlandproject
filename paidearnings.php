...
<body class="profile-body">
    ...
    <div class="flex-container">
        ...
        <div class="profile-container">
                ...
                <div>
                    ...
                    <div class="payment-desc">
                        ...
                        <div class="payment-count">
                            &#8358;<span><?php 
                        $user = new User;
                        $unitprice2 = $user->selectAgentTotalPaidEarnings($_SESSION['uniqueagent_id']);
            ...
            $earning = $user->selectAgentPaidHistory($newuser['uniqueagent_id']);
            if(!empty($earning)){
    ...
    ?>
                ...
                <div class="success">
                    ...
                    <p>You have no paid earnings yet!</p>
                </div>
                <?php }?>
