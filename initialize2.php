...
$insertpayment =
$land->insertPayment($uniqueperson,$uniqueproduct,$product_name,$paymentmonth,$paymentday,$paymentyear,$paymenttime,$productlocation,$price,$image,$added_unit,$paymentmethod,$paymentdate,$_GET['data'],$intervalinput,round($price),$payee,$agentid,$allocationfee,$limitperiod,$totalprice,$filename,$newbalance,$newpayid,$balance,round($price));

$inserthistory =
$land->insertPayHistory2($uniqueperson,$uniqueproduct,$product_name,$paymentmonth,$paymentday,$paymentyear,$paymenttime,$productlocation,$price,$image,$added_unit,$paymentmethod,$paymentdate,$_GET['data'],$intervalinput,round($price),$payee,$agentid,$allocationfee,$limitperiod,$filename,$newpayid,$balance,round($price));


$update = $land->updateUnit($deducted_unit,$uniqueproduct);
} else {
$insertpayment =
$land->insertPayment($uniqueperson,$uniqueproduct,$product_name,$paymentmonth,$paymentday,$paymentyear,$paymenttime,$productlocation,$price,$image,$_GET['unit'],$paymentmethod,$paymentdate,$_GET['data'],$intervalinput,round($price),$payee,$agentid,$allocationfee,$limitperiod,$totalprice,$filename,$newbalance,$newpayid,$balance,round($price));

$inserthistory =
$land->insertPayHistory2($uniqueperson,$uniqueproduct,$product_name,$paymentmonth,$paymentday,$paymentyear,$paymenttime,$productlocation,$price,$image,$_GET['unit'],$paymentmethod,$paymentdate,$_GET['data'],$intervalinput,round($price),$payee,$agentid,$allocationfee,$limitperiod,$filename,$newpayid,$balance,round($price));
$update = $land->updateUnit($deducted_unit,$uniqueproduct);
}
