    ...
    <section class="login-form-container">
        <form action="" class="login-form" id="login-form">
            ...
            <div class="input-div email">
                ...
                <input type="text" id="referralid" name="refid" value="" placeholder="Input agent's referral id" />
                <div id="createid">Create ID</div>
            </div>

            <div class="input-div email">
                <label for="percent">Earning Percentage</label>
                <input type="number" id="percent" name="percent" placeholder="Input agent's earning percentage" />
            </div>
